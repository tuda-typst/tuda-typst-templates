...
%% This is file `DEMO-TUDaPub.tex' version 4.06 (2026-06-08),
%% it is part of
%% TUDa-CI -- Corporate Design for TU Darmstadt
%% ----------------------------------------------------------------------------
%%
%% Copyright (C) 2018--2026 by Marei Peischl <marei@peitex.de>
%%
%% ============================================================================
...
%	accept-missing-logos=true,% No error in case logo files are not available
	logofile=tuda_logo,% In case logo should be replaced
]{tudapub}
...
% Language setup
%%%%%%%%%%%%%%%%%%%
\usepackage[ngerman,main=english]{babel}% load English and German to support a German abstract
